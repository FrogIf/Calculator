...
//        testThreeDimension();
    ...
    private static void testThreeDimension(){
        ...
        space.addPoint(new SymbolPoint("1", new Coordinate()));
        ...
        space.addPoint(new SymbolPoint("5", new Coordinate(0, 1, 0)));
        ...
        for(int x = 0; x < space.width(new Coordinate(0)); x++){
            System.out.println("(");
            for(int y = 0; y < space.width(new Coordinate(0, 0)); y++){
                System.out.print("    (");
                for(int z = 0; z < space.width(new Coordinate(0, 0, 0)); z++){
...
//        ISpace subspace = space.getSubspace(new Coordinate());
        ISpace subspace = space.getSubspace(new Coordinate(0, 1, 1));
...
//        System.out.println(space.width(new Coordinate(0, 0)));
        ...
        System.out.println(space.getPoint(new Coordinate(0, 0)).intrinsic());
        System.out.println(space.getPoint(new Coordinate(1, 1)).intrinsic());
...
//        TestUtil.showList(space.getPoints());
//        System.out.println();
//        ISpace subspace = space.getSubspace(new Coordinate(2));
//        System.out.println(subspace.dimension());
//        TestUtil.showList(subspace.getPoints());
    }
