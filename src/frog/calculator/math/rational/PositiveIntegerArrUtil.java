...
class PositiveIntegerArrUtil {
    ...
    private static int[][] divideKnuth(int[] dividend, int[] divisor){
        ...
        // D1 规范化
//            int shift = Integer.numberOfLeadingZeros(divisor[divisor.length - 1]) - SCALE_LEAD_ZERO_COUNT; // d = power(2, shift)
...
//           b = num[i + 1];
//           borrow = b % 2;
//           result[i] = (int) ((a + (long)borrow * SCALE) / 2);
//       }
//
//       a = (num[i] - borrow) / 2;
//       if(a != 0){}
