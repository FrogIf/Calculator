...
class OldPositiveIntegerUtil {
    ...
    static StringBuilder multiply(StringBuilder left, StringBuilder right){
        if(left == OldIntegerNumber.ONE_STR){ return right; }
        else if(right == OldIntegerNumber.ONE_STR) { return left; }
    ...
    private static StringBuilder floorHalf(StringBuilder num){
        if(num.length() == 1 && num.charAt(0) == '0'){return OldIntegerNumber.ZERO_STR;}
    ...
    static StringBuilder gcd(StringBuilder left, StringBuilder right){
        ...
        StringBuilder d = OldIntegerNumber.ONE_STR;

        while(a != OldIntegerNumber.ZERO_STR && b != OldIntegerNumber.ZERO_STR){
        ...
        if(a == OldIntegerNumber.ZERO_STR){ return multiply(d, b); }
