...
public class TreeMapTest extends AbstractTestContent<TreeMapTestObject> {
    ...
    protected boolean singleStepTest(TreeMapTestObject caseObj) {
        ...
        ISet<IMap.Entry<String, String>> entrySet = caseObj.map.entrySet();
        Iterator<IMap.Entry<String, String>> itr = entrySet.iterator();
        while(itr.hasNext()){
            IMap.Entry<String, String> entry = itr.next();
